...
//           <div className="mx-auto w-24 h-1 rounded-full bg-gradient-to-r from-indigo-600 via-blue-500 to-cyan-400 mb-6" />
...
//             <article key={index} className="group relative rounded-2xl p-[1px] bg-gradient-to-r from-indigo-500 via-blue-500 to-cyan-400 overflow-hidden transition-all hover:scale-[1.01] overflow-hidden">
...
//                 <div>
//                   <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 inline-flex items-center justify-center text-white mb-5 shadow-md transform transition-transform group-hover:scale-110">
//                     {service.icon}
//                   </div>
...
//                       {service.title}
//                       <span className="absolute left-0 -bottom-1 block h-0.5 w-full bg-gradient-to-r from-indigo-600 via-blue-500 to-cyan-400 scale-x-0 transform origin-left transition-transform group-hover:scale-x-100" />
//                     </span>
//                   </h3>
...
//                   <Link href={service.link} className="inline-flex items-center gap-2 text-sm font-medium text-indigo-600 hover:text-indigo-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300">
//                     Learn more
