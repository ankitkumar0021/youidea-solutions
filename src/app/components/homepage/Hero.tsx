      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="text-center lg:text-left">
            <h1 className="font-montserrat text-3xl lg:text-4xl font-bold text-gray-900 mb-6 leading-tight">
              Grow Your <span className="text-[#d4111e]">Business</span> with Code Mantra Technologies
            </h1>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
              <Link href={`/contact`} className="px-8 py-4 bg-[#d4111e] hover:bg-[#ff4b51] text-white rounded-lg font-medium shadow-lg transition-all flex items-center group">
                Get Started 
                <HiArrowRight className="ml-2 transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href={`/portfolio`} className="px-8 py-4 bg-white text-gray-800 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors">
                View Our Work
              </Link>
            </div>
