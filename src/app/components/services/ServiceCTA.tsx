...
const ServiceCTA = () => {
  ...
  <div>
    <input
      ...
      className="w-full px-4 py-3 border border-gray-300 rounded-lg placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
    />
  </div>
  <div>
    <input
  ...
  <div>
    <select
      className="w-full px-4 py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      defaultValue=""
    >
